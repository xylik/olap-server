...
public class OlapDiscoverService implements Serializable {
	...
	public List<SaikuLevel> getAllHierarchyLevels(SaikuCube cube, String dimensionName, String hierarchyName) {
		try {
			...
			throw new SaikuServiceException("Cannot get all levels for cube ( " + cube + " ) dimension ( " + dimensionName
	...
	public List<SimpleCubeElement> getLevelMembers(SaikuCube cube, String hierarchyName, String levelName, String searchString,
			int searchLimit) {
		try {
			...
			throw new SaikuServiceException("Cannot get all members for cube ( " + cube + " ) hierarchy ( " + hierarchyName + " )", e);
		}
	}
